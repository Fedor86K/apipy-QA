...
- Следуя информационным указаниям выберите тестируемый метод и необходимость сохранения отчета
...
!обратите внимание, что скрипт не визуализирует Response headers
